...
export interface AuthenModalHandle {
  isVisible: boolean;
  setIsVisible: (value: boolean) => void;
}

const AuthenModal = (props: Record<string, any>, ref: React.Ref<AuthenModalHandle>) => {
...
export default forwardRef<AuthenModalHandle>(AuthenModal);

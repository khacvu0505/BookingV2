...
export const displayPhoneInfo = () => (
  <>
    <div>
      <i
        className="ri-phone-fill text-white text-14 bg-primary-500 size-26 p-1 rounded-full mr-4"
        aria-hidden="true"
      />

    </div>
    <span className="text-13 text-neutral-800 fw-400">
...
export const DisplayGiftInfo = () => {
  ...
  return (
    <>
      ...
      <p className="text-13 text-neutral-800 fw-400">

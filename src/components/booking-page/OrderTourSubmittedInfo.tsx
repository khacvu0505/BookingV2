...
import InvoiceTourComponent from "@/components/invoice/InvoiceTour";

const OrderTourSubmittedInfo = () => {
        ...
        <div className="order-completed-wrapper">
          {!bookingInfo ? (
            <div className="d-flex flex-column justify-content-center items-center mt-40 lg:md-40 sm:mt-24">
              ...
              <div className="text-30 lh-1 fw-600 mt-20">Đặt tour thất bại</div>
            </div>
          ) : (
            <div className="d-flex flex-column justify-content-center items-center mt-40 lg:md-40 sm:mt-24">
          ...
          {!bookingInfo ? (
            ...
            <>
              <div className="border-type-1 rounded-8 px-30 px-md-50 py-10 py-md-35 mt-20 mb-20 mt-md-40 mb-md-40">
                <div className="row justify-content-center">
                  <div className="col-lg-3 col-md-6 px-0 mb-10">
                    <div className="text-15 lh-12">Mã đặt tour</div>
                  ...
                  {/* End .col */}
                  <div className="col-lg-3 col-md-6 px-0 mb-10">
                    <div className="text-15 lh-12">Thời gian</div>
                    <div className="text-15 lh-12 fw-500 text-blue-1">
              ...
              <InvoiceTourComponent bookingInfo={bookingInfo} />
            </>
          )}
        </div>
      </div>
...
export default OrderTourSubmittedInfo;

...
const GuestSearch = ({ handleChangeValue }) => {
  ...
  const handleCounterChange = (name, value) => {
    ...
    handleChangeValue({ name: name, value: value });
  };
  return (
    <div className="searchMenu-guests px-30 lg:py-10 lg:px-0 js-form-dd js-form-counters">
      <div
      ...
      >
        ...
        <div className="text-15 text-light-1 ls-2 lh-16">
          <span className="js-count-adult">{guestCounts.adults}</span> người lớn
          - <span className="js-count-child">{guestCounts.children}</span> trẻ
          em - <span className="js-count-room">{guestCounts.room}</span> phòng
        </div>
      </div>
      {/* End guest */}

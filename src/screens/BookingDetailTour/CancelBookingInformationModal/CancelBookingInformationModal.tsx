...
const CancelBookingInformationModal = (
  { bookingDetail, setCancelSuccess },
  ref
) => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={classNames("text-right pr-10 pt-5", {
          ...
          {requestSuccess ? (
            ...
            <div className="text-20 fw-500 lh-15 w-100 text-center">
              <p className="text-24 fw-500 text-neutral-800">
                {t("COMMON.CANCEL_BOOKING_TOUR_INFO")}
        ...
        {requestSuccess ? (
          <div className="mb-30 px-20">
            <p className="text-dark">{t("COMMON.SUPPORT_TEXT")}</p>
          ...
          <div className="px-20">
            <div className="d-flex items-center">
              <div className="d-flex items-center mr-24">
                <p className="text-14 fw-400 mr-4">{t("COMMON.TOUR_NAME")}: </p>

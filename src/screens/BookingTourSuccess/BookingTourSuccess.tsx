...
import { clearSessionStorage, formatStringToDate } from "@/utils/utils";
...
const BookingTourSuccess = () => {
  ...
  const handleGetBookingInfo = async () => {
    try {
      setIsLoading(true);
      const res = await getBookingInfoTour(id as string);
      if (res.success) {
      ...
      <div>
        <div className="order-completed-wrapper">
          {!bookingInfo ? (
            <div className="d-flex flex-column justify-content-center items-center mt-40 lg:md-40 sm:mt-24">
              ...
              <div className="text-30 lg:text-26 md:text-22 lh-1 fw-600 mt-20">
                {t("BOOKING_SUCCESS_TOUR.BOOKING_FAILED")}
              </div>
            </div>
          ) : (
            <div className="d-flex flex-column justify-content-center items-center mt-40 lg:md-40 sm:mt-24">
          ...
          {!bookingInfo ? (
            ...
            <>
              <div
                className="d-flex flex-wrap justify-content-center lg:justify-between border-type-1 rounded-8 px-24 py-24 mb-53 relative"
                style={{
              ...
              >
                <div className="col-12 col-md-6 col-lg-3 px-0">
                  <div className="text-16 lg:text-15 md:text-14 fw-400 text-neutral-500">
                    {t("BOOKING_SUCCESS_TOUR.BOOKING_CODE")}
                  </div>
                ...
                <div className="col-12 col-md-6 col-lg-3 px-0">
                  ...
                  <div className="text-18 lg:text-17 md:text-16 fw-500 text-primary-500">
                    {formatStringToDate(bookingInfo?.bookingDate)}
                  </div>
                </div>
                <div className="col-12 col-md-6 col-lg-3 px-0">
                  <div className="text-16 lg:text-15 md:text-14 fw-400 text-neutral-500">

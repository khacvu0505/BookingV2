  ...
  return (
    <>
      <div className="row mb-30">
        <div className="d-flex justify-content-between items-center flex-wrap mt-20 sm:px-10">
      ...
      {hotelList.length > 0 ? (
        hotelList.map((item, index) => (
          <div className="col-12 md:mb-70 sm:mb-30" key={index}>
            <div
              className="row items-center bg-white mb-20 py-15 px-0 rounded-8 border-light"
              style={{
                background:
            ...
            >
              ...
              <div className="col-12 col-sm-7 col-md-8 col-lg-9 md:py-0">
                <div
                  className="d-flex items-center pointer lg:flex-column lg:items-start"
                  onClick={() => handleClickShowInfoCustomer(item?.bookingID)}
                >
                  <div className="d-flex items-center sm:mb-10">
                    <TagComponent
                ...
                <div className="d-flex items-center justify-content-between flex-wrap mb-16 sm:flex-column sm:items-start lg:mt-20">
                  <h3
                    className="text-18 lg:text-17 mnd:text-16 fw-500 text-neutral-800 cursor-pointer"
                    onClick={() => handleClickShowInfoCustomer(item?.bookingID)}
                  >
                    {item?.supplierName}
                  </h3>
                  <PriceWithVND
                    ...
                    className="text-24 lg:text-22 md:text-20 fw-600 text-primary-500"
                  ...
                  <div>
                    <div className="d-flex items-center justify-content-between mb-8">
                      ...
                      {isFinishTab && Boolean(!item?.isFeedback) && (
                        <p
                          className="italic underline text-14 fw-400 text-primary-500 pointer d-block sm:d-none"
            ...
            <RatingModal ref={refRatingModal} setHotelList={setHotelList} />
